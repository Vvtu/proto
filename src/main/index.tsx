    ...
    <React.Fragment>
      ...
      <Container className={classes.container}>
        <Widget
          ...
          link={'/customer-form'}
          label={`ОРП`}
          tip={'ОРП это такая большая форма с многими полями'}
        ...
        <Widget
          ...
          label={`Проект`}
          tip={TIP_MESSAGE}
          subNames={PROJECT_SUBNAMES}
        />
        <Widget
          setErrorFired={setErrorFired}
          label={`Бизнес-план`}
          tip={TIP_MESSAGE}
          subNames={BUSINESS_PLAN_SUBNAMES}
        />
        <Widget
          setErrorFired={setErrorFired}
          label={`Документ`}
          tip={TIP_MESSAGE}
          subNames={DOCUMENT_SUBNAMES}
        />
      </Container>
      <Copyright />
      {errorFired && <TransitionsModal message={errorFired} onClose={() => setErrorFired('')} />}
    </React.Fragment>
  );
}
